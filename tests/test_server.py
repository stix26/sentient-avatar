...
@pytest.fixture
def client(mock_llm_service, mock_asr_service, mock_tts_service, 
           mock_avatar_service, mock_vision_service, mock_vector_store_service):
    with patch("sentient_avatar.avatar_server.LLMService", return_value=mock_llm_service), \
         patch("sentient_avatar.avatar_server.ASRService", return_value=mock_asr_service), \
         patch("sentient_avatar.avatar_server.TTSService", return_value=mock_tts_service), \
         patch("sentient_avatar.avatar_server.AvatarService", return_value=mock_avatar_service), \
         patch("sentient_avatar.avatar_server.VisionService", return_value=mock_vision_service), \
         patch("sentient_avatar.avatar_server.VectorStoreService", return_value=mock_vector_store_service):
