...
class ModelOptimizer:
        ...
        async def optimize_model(request: OptimizationRequest):
            try:
                ...
                if request.optimization_type == "quantization":
                    ...
                    raise HTTPException(
                        status_code=400,
                        detail="Invalid optimization type"
                    )
    ...
    def _quantize_model(self, model_path: str, config: Dict[str, Any]) -> torch.nn.Module:
    ...
    def _distill_model(self, model_path: str, config: Dict[str, Any]) -> torch.nn.Module:
    ...
    def _compute_distillation_loss(self, student_logits: torch.Tensor, teacher_logits: torch.Tensor, temperature: float) -> torch.Tensor:
    ...
    def _save_optimized_model(self, model: torch.nn.Module, original_path: str, optimization_type: str) -> str:
        """Save optimized model."""
    ...
    def _log_optimization(self, model_path: str, optimization_type: str, config: Dict[str, Any], output_path: str):
        ...
        try:
            ...
            metrics = {
                ...
                "optimization_time": OPTIMIZATION_TIME.labels(optimization_type).observe()
            }
