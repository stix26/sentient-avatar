...
class GrafanaDashboard:
    ...
    def create_alert_rule(
        self, name: str, condition: str, duration: str, severity: str
    ) -> Dict:
    ...
    def create_notification_channel(self, name: str, type: str, settings: Dict) -> Dict:
        ...
        channel = {"name": name, "type": type, "settings": settings, "isDefault": False}
    ...
    def setup_default_notifications(self) -> None:
        ...
        self.create_notification_channel(
            name="Email Alerts",
            type="email",
            settings={"addresses": "admin@example.com", "singleEmail": True},
        )
        ...
        self.create_notification_channel(
            ...
            type="pagerduty",
            settings={"integrationKey": "your-integration-key", "severity": "critical"},
        )
