...
class MetricsCollector:
    ...
    def track_service_latency(self, service: str, operation: str, duration: float):
        ...
        """
        self.service_latency.labels(service=service, operation=operation).observe(duration)
        ...
        def decorator(func):
            ...
            async def wrapper(*args, **kwargs):
                ...
                try:
                    ...
                    self.track_request(method, endpoint, status, time.time() - start_time)
                    return response
                except Exception as e:
        ...
        def decorator(func):
            ...
            async def wrapper(*args, **kwargs):
                ...
                try:
                    ...
                    self.track_service_latency(service, operation, time.time() - start_time)
                    return result
                except Exception as e:
                    self.track_service_latency(service, operation, time.time() - start_time)
                    raise
    ...
    def get_metrics(self) -> Dict[str, Any]:
        ...
        metrics = {
            ...
            'services': {
                ...
                'latency': {k: v._sum.get() for k, v in self.service_latency._metrics.items()}
            },
            'system': {
