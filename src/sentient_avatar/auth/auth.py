...
class AuthService:
    ...
    async def create_user(self, email: str, username: str, password: str, roles: List[str] = None) -> User:
    ...
    async def login(self, email: str, password: str, mfa_token: Optional[str] = None) -> Token:
